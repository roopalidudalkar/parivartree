...
class TestController extends Controller
{
	...
	//	print_r($messages);
		...
		//return new Response($mytree);
	}
	
	public function mytreeJsonAction($nodeid, Request $request)
	{
 	/*	$session = $this->container->get('session');
		$em = $this->getDoctrine()->getManager();
		...
		for($i = 0; $i < $toptreecount; $i++){
			...
			if($toptree[$i]['relationid'] == 1){
				$tree['top'][0]['relationid'] = $toptree[$i]['relationid'];
				$tree['top'][0]['params'][$i]['id'] = $toptree[$i]['relnodeid'];
				$tree['top'][0]['params'][$i]['firstname'] = $toptree[$i]['firstname'];
				$tree['top'][0]['params'][$i]['lastname'] = $toptree[$i]['lastname'];
				$tree['top'][0]['params'][$i]['city'] = $toptree[$i]['city'];
				$tree['top'][0]['params'][$i]['login_status'] = $toptree[$i]['login_status'];
				$tree['top'][0]['params'][$i]['invited'] = $toptree[$i]['invited'];
				$tree['top'][0]['params'][$i]['gender'] = $toptree[$i]['gender'];
				$tree = "[".json_encode($tree)."]";
			}
			elseif($toptree[$i]['relationid'] == 2){
				json_encode($tree);
				$tree['top'][1]['relationid'] = $toptree[$i]['relationid'];
				$tree['top'][1]['params'][$i]['id'] = $toptree[$i]['relnodeid'];
				$tree['top'][1]['params'][$i]['firstname'] = $toptree[$i]['firstname'];
				$tree['top'][1]['params'][$i]['lastname'] = $toptree[$i]['lastname'];
				$tree['top'][1]['params'][$i]['city'] = $toptree[$i]['city'];
				$tree['top'][1]['params'][$i]['login_status'] = $toptree[$i]['login_status'];
				$tree['top'][1]['params'][$i]['invited'] = $toptree[$i]['invited'];
				$tree['top'][1]['params'][$i]['gender'] = $toptree[$i]['gender'];							
				$tree = "[".json_encode($tree)."]";
			}
		}
		...
		for($i = 0; $i < $parelleltreecount; $i++){
			...
			if($parelleltree[$i]['relationid'] == 0){
				 $tree['parallel'][0]['relationid'] = $parelleltree[$i]['relationid'];
        	                 $tree['parallel'][0]['id'] = $parelleltree[$i]['relnodeid'];
	 			$tree['parallel'][0]['firstname'] = $parelleltree[$i]['firstname'];
				$tree['parallel'][0]['lastname'] = $parelleltree[$i]['lastname'];
				$tree['parallel'][0]['city'] = $parelleltree[$i]['city'];
				$tree['parallel'][0]['login_status'] = $parelleltree[$i]['login_status'];
				$tree['parallel'][0]['invited'] = $parelleltree[$i]['invited'];
				$tree['parallel'][0]['gender'] = $parelleltree[$i]['gender'];
				$j++;
			}
		}
		...
		for($i = 0; $i < $parelleltreecount; $i++){
			if($parelleltree[$i]['relationid'] == 3 || $parelleltree[$i]['relationid'] == 8){
	              		$tree['parallel'][1]['relationid'] = $parelleltree[$i]['relationid'];
	              	$tree['parallel'][1]['params'][$i]['id'] = $parelleltree[$i]['relnodeid'];
        			$tree['parallel'][1]['params'][$i]['relationid'] = $parelleltree[$i]['relationid'];
				$tree['parallel'][1]['params'][$i]['firstname'] = $parelleltree[$i]['firstname'];
				$tree['parallel'][1]['params'][$i]['lastname'] = $parelleltree[$i]['lastname'];
				$tree['parallel'][1]['params'][$i]['city'] = $parelleltree[$i]['city'];
				$tree['parallel'][1]['params'][$i]['login_status'] = $parelleltree[$i]['login_status'];
				$tree['parallel'][1]['params'][$i]['invited'] = $parelleltree[$i]['invited'];
				$tree['parallel'][1]['gender'] = $parelleltree[$i]['gender'];
			}
                }
		...
		if($bottomtree[$i]['relationid'] == 6 || $bottomtree[$i]['relationid'] == 7){
				...
				$tree['child'][0]['relationid'] = $bottomtree[$i]['relationid'];
                        	$tree['child'][0]['params'][$i]['relationid'] = $bottomtree[$i]['relationid'];
				$tree['child'][0]['params'][$i]['id'] = $bottomtree[$i]['relnodeid'];
				$tree['child'][0]['params'][$i]['firstname'] = $bottomtree[$i]['firstname'];
				$tree['child'][0]['params'][$i]['lastname'] = $bottomtree[$i]['lastname'];
				$tree['child'][0]['params'][$i]['city'] = $bottomtree[$i]['city'];
				$tree['child'][0]['params'][$i]['login_status'] = $bottomtree[$i]['login_status'];
				$tree['child'][0]['params'][$i]['invited'] = $bottomtree[$i]['invited'];
				$tree['child'][0]['params'][$i]['gender'] = $bottomtree[$i]['gender'];
			}
                } 
	...
	//	print_r($tree);		
		for($i = 0; $i < $parelleltreecount; $i++){
                        if($parelleltree[$i]['relationid']!=0 && $parelleltree[$i]['relationid']!=8 && $parelleltree[$i]['relationid']!=3 ){
                        	$tree['sibling'][0]['relationid'] = $parelleltree[$i]['relationid'];
                        	$tree['sibling'][0]['params'][$i]['relationid'] = $parelleltree[$i]['relationid'];
                         	$tree['sibling'][0]['params'][$i]['id'] = $parelleltree[$i]['relnodeid'];
				$tree['sibling'][0]['params'][$i]['firstname'] = $parelleltree[$i]['firstname'];
				$tree['sibling'][0]['params'][$i]['lastname'] = $parelleltree[$i]['lastname'];
				$tree['sibling'][0]['params'][$i]['city'] = $parelleltree[$i]['city'];
				$tree['sibling'][0]['params'][$i]['login_status'] = $parelleltree[$i]['login_status'];
				$tree['sibling'][0]['params'][$i]['invited'] = $parelleltree[$i]['invited'];
				$tree['sibling'][0]['params'][$i]['gender'] = $parelleltree[$i]['gender'];
                        }
                } 
		//print_r($tree);	
		$form->handleRequest($request);
