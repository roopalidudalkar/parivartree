...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('anup@netiapps.com');
        $a->setPassword('battasha123$$');
        $a->setAuthMode(NULL);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'anup@netiapps.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'battasha123$$',
