...
/* AdminAdminBundle:Admin:lastaccessed.html.twig */
class __TwigTemplate_3cb0165dddcb0c107db1eb0890b6ff78e963fa1e7cd560d92948d4334a43b2b9 extends Twig_Template
{
...
\t<h4>User last accessed IP Adress</h4>
...
\t\t<td>";
            // line 30
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "d"), "login_ip"), "html", null, true);
            echo "</td>
\t\t<td>";
            // line 31
            echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "d"), "logout_ip"), "html", null, true);
            echo "</td>
\t\t</tr>
\t";
        }
...
";
    ...
    {
        return "AdminAdminBundle:Admin:lastaccessed.html.twig";
    }
