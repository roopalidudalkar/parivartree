...
class TreeController extends Controller
{
	public function addnodeAction($nodeid, $relationid,  Request $request)
		...
		$form = $this->createFormBuilder($user)
								...
								->add('firstname', 'text', array('trim'=>TRUE, 'mapped'=>FALSE, 'attr'=>array('class'=>'form-control')))
								->add('lastname', 'text', array('trim'=>TRUE, 'mapped'=>FALSE, 'attr'=>array('class'=>'form-control')))
